...
- [iclawapp/iclaw](https://github.com/iclawapp/iclaw) ![GitHub Repo stars](https://img.shields.io/github/stars/iclawapp/iclaw?style=social) - Local-first AI workspace with built-in sandbox — drops files into isolated containers, detects malware, credential theft, and exfiltration. Every file runs in a container before it touches your machine. npm: `@iclawapp/iclaw`
