...
- [thebrierfox/yield-intelligence-skill](https://github.com/thebrierfox/yield-intelligence-skill) ![GitHub Repo stars](https://img.shields.io/github/stars/thebrierfox/yield-intelligence-skill?style=social) - Passive income portfolio analysis: US Treasury yield curves, dividend ETFs, REITs. Live yield data, no API key needed. BYOK. MIT.
- [thebrierfox/moatmri-skill](https://github.com/thebrierfox/moatmri-skill) ![GitHub Repo stars](https://img.shields.io/github/stars/thebrierfox/moatmri-skill?style=social) - AI disruption pressure analysis — 10-vector pressure map for businesses facing AI disruption. BYOK. MIT.
- [thebrierfox/doc2math-skill](https://github.com/thebrierfox/doc2math-skill) ![GitHub Repo stars](https://img.shields.io/github/stars/thebrierfox/doc2math-skill?style=social) - Document-to-mathematics formalization — converts any document into structured mathematical problem sets. BYOK. MIT.
- [thebrierfox/ai-identity-persistence-contract](https://github.com/thebrierfox/ai-identity-persistence-contract) ![GitHub Repo stars](https://img.shields.io/github/stars/thebrierfox/ai-identity-persistence-contract?style=social) - AI identity persistence via read-only document contract — four-layer architecture for persistent agents that survive context window resets. MIT.
