...
- [now4real/openclaw-now4real](https://github.com/now4real/openclaw-now4real) ![GitHub Repo stars](https://img.shields.io/github/stars/now4real/openclaw-now4real?style=social) - Official Now4real plugin for OpenClaw that lets website visitors chat with an OpenClaw assistant through the Now4real widget.
